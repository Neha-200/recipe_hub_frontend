...
export default function Register (){
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(user);
        try {
            const response = await fetch(`https://recipe-hub-backend.onrender.com/api/auth/register`,{
               method:"POST", 
                        ...
                        <div className="registration-form">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="reg" style={{ position: "relative"}}>
                                    ...
                                    style={{ width: "70%", padding: "0.5rem", margin: "0.5rem 0" }}
                                    />
                                    <div onClick={handleClick} style={{ position: "absolute", left: "22rem", top: "35px", cursor: "pointer" }}>{password ? <Eye/> : <EyeOff/>}</div>
                                </div>
                                <br/>
